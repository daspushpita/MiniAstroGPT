...
INPUT_JSONL = Path(
    ...
    "MiniAstroLM/data/teacher/v1/train.jsonl"
)

OUTPUT_JSONL = Path("data/evals/eval_human/inspection_subset.jsonl")
OUTPUT_MD    = Path("data/evals/eval_human/inspection_subset.md")
